...
const FullStack = () => {
   ...
   <div className={styles.body}>
     <p className={styles.text}>Soy un programador con enfoque en el desarrollo de aplicaciones web, tengo habilidade tanto en el Front-end como en el el Back-end. sin embargo mi especialidad y enfoque principal está en el Front-end.</p><span className={styles.username}>from:jamy_10011</span>
