...
const Proyectos = () => {
   ...
   <div className={styles.body}>
     <p className={styles.text}>Lorem ipsum dolor sit amet, consectetur adipiscing elit. In massa ipsum, laoreet quis mollis nec, feugiat in dui. Suspendisse et enim pretium, ullamcorper enim laoreet.</p><span className={styles.username}>from: @Yaya12085</span>
