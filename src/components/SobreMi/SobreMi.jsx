...
<div class="card"> 
   ...
   <div className={styles.body}>
     <p className={styles.text}>Hola ¿Que tal?, Me llamo John Alexander Muñoz Yepez de Medellin-Colombia. Soy una persona apasionada por la tecnología y los deportes, de este ultimo es de donde adquirí mi disciplina y constancia, ya que creo que los deportes son la manera mas eficaz de desarrollar estas cualidades.
     ...
     <span>+20</span>
            ...
            <div className={styles.academico}>
                ...
                <h1>Educación</h1>
                    ...
                    <div className={styles.card}>
                        <h2>Soy Henry</h2>
                        <span>enero 2023 a julio 2023</span>
                    </div>
                    <div  className={styles.card}>
                        <h2>Frecodecamp</h2>
